...
var ResizeHandle = _styled.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\theight: 100%;\n\twidth: 10px;\n\tdisplay: flex;\n\tflex-direction: column;\n\tjustify-content: center;\n\talign-items: center;\n\tcursor: col-resize;\n\tcolor: #0085ff;\n\t::after {\n\t\tcontent: \"\u22EE\";\n\t}\n\t:hover {\n\t\tcolor: #0b6fcc;\n\t\tbackground-color: rgba(0, 0, 0, 0.1)\n\t}\n"])));

function ColumnResizer(_ref) {
  ...
  if (drag) style = _objectSpread(_objectSpread({}, style), {}, {
