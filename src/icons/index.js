...
const IconVoteYes = (props) =>
	<IconSVG {...props} viewBox="0 0 600 600">
		<defs id="defs1373">
...
const IconVoteNo = (props) =>
	<IconSVG {...props} viewBox="0 0 525 600">
		<defs id="defs5">
...
export const Icon = ({type, name, ...rest}) => {
	let icon = faIcons[type || name];
	if (icon)
...
const _ActionIcon = ({disabled, onClick, ...rest}) => <Icon disabled={disabled} onClick={disabled? undefined: onClick} {...rest} />
